...
def worker1(path):
    print("\nFull text from worker 1:",subtitle_with_threading.get_large_audio_transcription(path))

def worker2(path):
    print("\nFull text from worker 2:",subtitle_with_threading.get_large_audio_transcription(path))
	
def worker3(path):
    print("\nFull text from worker 3:",subtitle_with_threading.get_large_audio_transcription(path))
