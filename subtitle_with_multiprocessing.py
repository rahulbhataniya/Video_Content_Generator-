...
def worker1(path,start_time):
	
    print("\nFull text from worker 1:",sbtitle_without_threading.get_large_audio_transcription(path))
    

def worker2(path):
	
    print("\nFull text from worker 2:",sbtitle_without_threading.get_large_audio_transcription(path))
	
def worker3(path):
	
    print("\nFull text from worker 3:",sbtitle_without_threading.get_large_audio_transcription(path))
